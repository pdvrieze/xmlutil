...
abstract class TestFloatCommon {
    ...
    protected open fun init() {
        mockEncoder = mock(MockMode.autoUnit) {
            ...
            every { encodeFloat(capture(floatArg)) }.returnsBy {
                mockEncoder.encodeString(floatArg.get().toString())
            }
        }
