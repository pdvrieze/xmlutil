...
internal class AppendableWriter(private val appendable: Appendable) : Writer() {
    ...
    override fun write(c: Int): Unit = reentrantLock {
        appendable.append(c.toChar())
    }

    override fun write(cbuf: CharArray, off: Int, len: Int): Unit = reentrantLock {
        appendable.append(CharArraySequence(cbuf, off, len))
    }

    override fun write(str: String, off: Int, len: Int): Unit = reentrantLock {
