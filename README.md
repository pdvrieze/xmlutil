...
```
   implementation("io.github.pdvrieze.xmlutil:serialization-jvm:1.0.0-rc2-SNAPSHOT")
```

#### js
```
   implementation("io.github.pdvrieze.xmlutil:serialization-js:1.0.0-rc2-SNAPSHOT")
```
