...
interface NCNameType<out T : XsdNCName> : NameType<T> {
    override val baseType: NameType<*> get() = NameType.Instance
    ...
    object Instance : NCNameType<XsdNCName>, BuiltinType {
        override val name: XsdQName = XsdQName(XMLConstants.XSD_NS_URI, "NCName", "xs")
