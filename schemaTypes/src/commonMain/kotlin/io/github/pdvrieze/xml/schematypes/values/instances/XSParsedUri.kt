...
/**
 * Instance of a URI that has been parsed into components.
 */
@ExperimentalXmlUtilApi
@Serializable(XSParsedUri.Serializer::class)
class XSParsedUri(str: String) : XSAnyURI {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is XSParsedUri) return super.equals(other)
    ...
    companion object Serializer : KSerializer<XSParsedUri> {
        override val descriptor: SerialDescriptor = PrimitiveSerialDescriptor("xsd.anyURI.parsed", PrimitiveKind.STRING)

        override fun deserialize(decoder: Decoder): XSParsedUri {
            return XSParsedUri(xmlCollapseWhitespace(decoder.decodeString()))
        }


        override fun serialize(encoder: Encoder, value: XSParsedUri) {
        ...
        private fun Char.checkValidUriChar(pos: Int = 0) {
            when (code) {
