...
interface FacetMaxExclusive : ConstrainingFacet.Fixed {
    ...
    companion object {
        operator fun invoke(value: XsdAnySimple, fixed: Boolean? = null): FacetMaxExclusive = Impl(value, fixed)

        val NAME: XsdQName = XsdQName(XSD_NS_URI, "maxExclusive", XSD_PREFIX)
    }
