...
interface FacetMaxExclusive : ConstrainingFacet.Fixed {
    ...
    companion object {
        operator fun invoke(value: XSAnySimple, fixed: Boolean? = null): FacetMaxExclusive = Impl(value, fixed)

        val NAME: XSQName = XSQName(XSD_NS_URI, "maxExclusive", XSD_PREFIX)
    }
