...
@Serializable(XsdAnySimple.Serializer::class)
interface XsdAnySimple {
    // inherits any
    val xmlString: String

    val schemaType: AnySimpleType<XsdAnySimple>

    private class Inst(val value: String) : XsdAnySimple {
        override val schemaType: AnySimpleType<XsdAnySimple> get() = AnySimpleType.Instance
    ...
    class Serializer : SimpleTypeSerializer<XsdAnySimple>("xsd.anySimpleType") {
        override fun deserialize(raw:String, input: XmlReader?): XsdAnySimple {
