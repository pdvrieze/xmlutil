...
interface NotationType : BuiltinPrimitiveDatatype<XSNotation> {
    ...
    object Instance: NotationType {
        override val name: XSQName get() = XSQName(XMLConstants.XSD_NS_URI, "NOTATION", "xs")
