...
interface GMonthDayType : BuiltinPrimitiveDatatype<XSMonthDayImpl> {
    ...
    object Instance: GMonthDayType {
        override val name: XSQName get() = XSQName(XMLConstants.XSD_NS_URI, "gMonthDay", "xs")
