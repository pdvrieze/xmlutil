...
interface GMonthType<out T : XSGMonth> : PrimitiveDatatype<T> {
    ...
    object Instance: GMonthType<XSGMonth>, BuiltinType {
        override val name: XSQName = XSQName(XMLConstants.XSD_NS_URI, "gMonth", "xs")
