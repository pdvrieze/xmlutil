...
import io.github.pdvrieze.xml.schematypes.values.instances.XsdTimeImpl
import kotlinx.serialization.Serializable
import nl.adaptivity.xmlutil.ExperimentalXmlUtilApi
import nl.adaptivity.xmlutil.XmlReader

@ExperimentalXmlUtilApi
@Serializable(XsdTime.Companion::class)
interface XsdTime : IXsdDateTime {

    override val schemaType: TimeType<XsdTime>
