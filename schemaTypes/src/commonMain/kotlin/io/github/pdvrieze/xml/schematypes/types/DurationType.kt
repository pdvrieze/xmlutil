...
interface DurationType<out T : XSDuration> : PrimitiveDatatype<T> {
    ...
    object Instance : DurationType<XSDuration>, BuiltinType {
        override val name: XSQName = XSQName(XMLConstants.XSD_NS_URI, "duration", "xs")
