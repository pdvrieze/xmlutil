...
interface DurationType : BuiltinPrimitiveDatatype<XSDuration> {
    ...
    object Instance : DurationType {
        override val name: XSQName get() = XSQName(XMLConstants.XSD_NS_URI, "duration", "xs")
