...
interface NameType<out T : XsdName> : TokenType<T> {
    ...
    object Instance : NameType<XsdName>, BuiltinType {
        override val name: XsdQName = XsdQName(XMLConstants.XSD_NS_URI, "Name", "xs")
