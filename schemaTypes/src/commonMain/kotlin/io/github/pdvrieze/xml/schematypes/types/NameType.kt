...
interface NameType<out T : XSName> : TokenType<T> {
    ...
    object Instance : NameType<XSName>, BuiltinType {
        override val name: XSQName = XSQName(XMLConstants.XSD_NS_URI, "Name", "xs")
