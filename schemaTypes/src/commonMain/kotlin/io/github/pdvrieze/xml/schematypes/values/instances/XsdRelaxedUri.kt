...
@Serializable(XsdRelaxedUri.Companion::class)
class XsdRelaxedUri(override val xmlString: String) : XsdAnyURI {
    ...
    companion object : SimpleTypeSerializer<XsdRelaxedUri>("xsd.anyURI.relaxed") {
        override fun deserialize(raw: String, input: XmlReader?): XsdRelaxedUri {
            return XsdRelaxedUri(xmlCollapseWhitespace(raw))
        }
    }
}
