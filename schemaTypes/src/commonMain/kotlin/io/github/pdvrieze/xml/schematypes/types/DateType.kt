...
interface DateType<out T : XSDate> : PrimitiveDatatype<T> {
    ...
    object Instance : DateType<XSDate>, BuiltinType {
        override val name: XSQName = XSQName(XMLConstants.XSD_NS_URI, "date", "xs")
