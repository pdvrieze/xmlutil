...
interface NormalizedStringType : BuiltinAtomicType<XSNormalizedString> {
    ...
    object Instance: NormalizedStringType {
        override val name: XSQName get() = XSQName(XMLConstants.XSD_NS_URI, "normalizedString", "xs")
