...
interface IXSDateTime: XSAtomic {
    /** any integer */
    val year: Int?
    ...
    fun secondFrag(): String =
        (second as? XSInteger)?.run { toInt().toString() } ?: second?.run { toDouble().toString() } ?: ""
    ...
    operator fun compareTo(other: XSDateTime): Int {
