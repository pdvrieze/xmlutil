...
interface GMonthDayType<out T : XSGMonthDay> : PrimitiveDatatype<T> {
    ...
    object Instance : GMonthDayType<XSGMonthDay>, BuiltinType {
        override val name: XSQName = XSQName(XMLConstants.XSD_NS_URI, "gMonthDay", "xs")
