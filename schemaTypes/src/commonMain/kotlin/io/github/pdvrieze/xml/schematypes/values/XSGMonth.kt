...
interface XSGMonth: IXSDateTime {
    ...
    companion object: SimpleTypeSerializer<XSGMonth>("xsd.gMonth") {
        override fun deserialize(raw: String, input: XmlReader?): XSGMonth {
            return XSGMonthImpl(raw.toInt(), null)
        }
    }
}
