...
interface NegativeIntegerType : AnyAtomicType, BuiltinAtomicType<XSInteger> {
    ...
    object Instance: NegativeIntegerType {
        override val name: XSQName get() = XSQName(XMLConstants.XSD_NS_URI, "negativeInteger", "xs")
