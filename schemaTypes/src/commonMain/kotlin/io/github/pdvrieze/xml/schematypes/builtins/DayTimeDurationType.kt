...
interface DayTimeDurationType : AnyAtomicType, BuiltinAtomicType<XSDuration> {
    ...
    object Instance: DayTimeDurationType {
        override val name: XSQName get() = XSQName(XMLConstants.XSD_NS_URI, "dayTimeDuration", "xs")
