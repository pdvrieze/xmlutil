...
interface UnsignedShortType : BuiltinAtomicType<XSUnsignedShort> {
    ...
    object Instance: UnsignedShortType {
        override val name: XSQName get() = XSQName(XMLConstants.XSD_NS_URI, "unsignedShort", "xs")
