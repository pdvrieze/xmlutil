...
import io.github.pdvrieze.xml.schematypes.values.instances.XsdByteImpl
import kotlinx.serialization.Serializable
import nl.adaptivity.xmlutil.ExperimentalXmlUtilApi
import nl.adaptivity.xmlutil.XmlReader

@Serializable(XsdByte.Companion::class)
@ExperimentalXmlUtilApi
interface XsdByte : XsdShort {
    override val schemaType: ByteType<XsdByte>
