...
@Serializable(XSAnySimple.Serializer::class)
interface XSAnySimple {
    // inherits any
    ...
    class Serializer : SimpleTypeSerializer<XSAnySimple>("xsd.anySimpleType") {
        override fun deserialize(raw:String, input: XmlReader?): XSAnySimple {
