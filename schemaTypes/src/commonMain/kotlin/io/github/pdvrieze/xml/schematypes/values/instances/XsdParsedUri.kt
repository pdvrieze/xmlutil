...
class XsdParsedUri(str: String) : XsdAnyURI {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is XsdParsedUri) return super.equals(other)
    ...
    companion object Serializer : KSerializer<XsdParsedUri> {
        override val descriptor: SerialDescriptor = PrimitiveSerialDescriptor("xsd.anyURI.parsed", PrimitiveKind.STRING)

        override fun deserialize(decoder: Decoder): XsdParsedUri {
            return XsdParsedUri(xmlCollapseWhitespace(decoder.decodeString()))
        }


        override fun serialize(encoder: Encoder, value: XsdParsedUri) {
