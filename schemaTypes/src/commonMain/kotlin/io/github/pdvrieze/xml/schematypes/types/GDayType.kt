...
interface GDayType<out T : XSGDay> : PrimitiveDatatype<T> {
    ...
    object Instance : GDayType<XSGDay>, BuiltinType {
        override val name: XSQName = XSQName(XMLConstants.XSD_NS_URI, "gDay", "xs")
