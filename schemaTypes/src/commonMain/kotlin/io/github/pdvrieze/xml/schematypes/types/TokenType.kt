...
interface TokenType<out T : XsdToken> : NormalizedStringType<T> {
    override val baseType: NormalizedStringType<*> get() = NormalizedStringType.Instance
    ...
    object Instance : TokenType<XsdToken>, BuiltinType {
        override val name: XsdQName = XsdQName(XMLConstants.XSD_NS_URI, "token", "xs")
