...
interface GYearType<out T : XSGYear> : PrimitiveDatatype<T> {
    ...
    object Instance: GYearType<XSGYear>, BuiltinType {
        override val name: XSQName = XSQName(XMLConstants.XSD_NS_URI, "gYear", "xs")
