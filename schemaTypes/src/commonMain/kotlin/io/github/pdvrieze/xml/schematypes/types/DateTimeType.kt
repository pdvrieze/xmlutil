...
interface DateTimeType<out T : XSDateTime> : PrimitiveDatatype<T> {
    ...
    object Instance : DateTimeType<XSDateTime>, BuiltinType {
        override val name: XSQName = XSQName(XMLConstants.XSD_NS_URI, "dateTime", "xs")
