...
import io.github.pdvrieze.xml.schematypes.values.instances.XsdNMTokenImpl
import io.github.pdvrieze.xml.schematypes.values.instances.XsdNMTokensImpl
import kotlinx.serialization.Serializable
import nl.adaptivity.xmlutil.ExperimentalXmlUtilApi
import nl.adaptivity.xmlutil.XmlReader

@ExperimentalXmlUtilApi
@Serializable(XsdNMTokens.Companion::class)
interface XsdNMTokens : XsdAnySimple, ListHelper<XsdNMToken> {
    ...
    companion object : SimpleTypeSerializer<XsdNMTokens>("xs.IDS") {
        override fun deserialize(raw: String, input: XmlReader?): XsdNMTokens {
            val members = raw.rawStringToCollapsedSequence()
                ...
                .toList()
            return XsdNMTokensImpl(members)
        }
    }
}
