...
interface XsdNotation: XsdAtomic {
    ...
    companion object : XmlSerializer<XsdNotation> {
        operator fun invoke(namespaceUri: String, localPart: String, prefix: String = ""): XsdNotation =
            XsdNotationImpl(namespaceUri, localPart, prefix)

        operator fun invoke(localPart: String): XsdNotation = XsdNotationImpl(localPart)
        ...
        override fun serialize(encoder: Encoder, value: XsdNotation) {
        ...
        @OptIn(ExperimentalSerializationApi::class)
        override fun deserialize(decoder: Decoder): XsdNotation {
            val qName = QNameSerializer.deserialize(decoder)
            return XsdNotationImpl(qName.namespaceURI, qName.localPart, qName.prefix)
        }
