...
interface XSGDay : IXSDateTime {
    ...
    companion object: SimpleTypeSerializer<XSGDay>("xsd.gDay") {
        override fun deserialize(raw: String, input: nl.adaptivity.xmlutil.XmlReader?): XSGDay {
            return XSGDayImpl(raw.toInt())
        }
    }
}
