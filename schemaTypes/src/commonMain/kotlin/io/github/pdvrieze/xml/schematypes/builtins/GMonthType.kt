...
interface GMonthType : BuiltinPrimitiveDatatype<XSGMonth> {
    ...
    object Instance: GMonthType {
        override val name: XSQName get() = XSQName(XMLConstants.XSD_NS_URI, "gMonth", "xs")
