...
interface DateTimeType : BuiltinPrimitiveDatatype<XSDateTime> {
    ...
    object Instance: DateTimeType {
        override val name: XSQName get() = XSQName(XMLConstants.XSD_NS_URI, "dateTime", "xs")
