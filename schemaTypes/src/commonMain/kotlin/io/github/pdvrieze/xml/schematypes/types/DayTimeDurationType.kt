...
interface DayTimeDurationType<out T : XsdDayTimeDuration> : DurationType<T> {
    ...
    object Instance: DayTimeDurationType<XsdDayTimeDuration>, BuiltinType {
        override val name: XsdQName = XsdQName(XMLConstants.XSD_NS_URI, "dayTimeDuration", "xs")
