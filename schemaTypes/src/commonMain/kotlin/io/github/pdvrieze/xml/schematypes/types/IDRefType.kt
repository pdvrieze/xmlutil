...
interface IDRefType<out T : XsdIDRef> : NCNameType<T> {
    ...
    object Instance: IDRefType<XsdIDRef>, BuiltinType {
        override val name: XsdQName = XsdQName(XMLConstants.XSD_NS_URI, "IDREF", "xs")
