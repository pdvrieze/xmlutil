...
open class XmlCodecBase internal constructor(val context: SerialContext?) {
    ...
    companion object {
        ...
        @JvmStatic
        protected fun SerialDescriptor.outputKind(index: Int): OutputKind {
            if (index < 0) {
...
open class XmlEncoderBase internal constructor(context: SerialContext?,
     ...
     */
    open inner class XmlEncoder(parentDesc: SerialDescriptor, elementIndex: Int) : XmlCodec(parentDesc,
