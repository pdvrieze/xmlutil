...
class CDataFields : PlatformTestBase<CDataFields.Business>(
    ...
    override val expectedXML: String =
        "<Business name=\"ABCD Corp\"><headOffice houseNumber=\"1\" status=\"VALID\"><street><![CDATA[ABC road ]]]]><![CDATA[> smile]]></street><city><![CDATA[ABCVille]]></city></headOffice></Business>"
    override val expectedJson: String =
        "{\"name\":\"ABCD Corp\",\"headOffice\":{\"houseNumber\":\"1\",\"street\":{\"street\":\"ABC road ]]> smile\"},\"city\":\"ABCVille\",\"status\":\"VALID\"}}"
