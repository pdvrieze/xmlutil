...
object ResNonNegativeIntegerType : ResolvedBuiltinAtomicType<XsdNonNegativeInteger>,
    ResIIntegerType<XsdNonNegativeInteger>, NonNegativeIntegerType<XsdNonNegativeInteger> {
    ...
    override fun validateValue(value: Any, version: SchemaVersion) {
        check(value is XsdNonNegativeInteger)  { "Value $value is not non-negative"}
    }
