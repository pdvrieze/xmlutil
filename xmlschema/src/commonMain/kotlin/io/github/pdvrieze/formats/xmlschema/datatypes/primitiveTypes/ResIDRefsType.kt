...
object ResIDRefsType : ResListDatatype<XsdIDRefs,  XsdIDRef>, IDRefsType<XsdIDRefs, XsdIDRef> {

    override val baseType: ResListDatatype<XsdAnySimple, XsdAnySimple> get() = AnonListBaseType
    override val itemType: ResIDRefType get() = ResIDRefType
    override val mdlItemTypeDefinition: ResIDRefType get() = itemType
