...
import io.github.pdvrieze.xml.schematypes.facets.FacetMinLength

class ResolvedMinLength(rawPart: XSMinLength) : ResolvedLengthBase(rawPart),
    IResolvedMinLength, FacetMinLength {
