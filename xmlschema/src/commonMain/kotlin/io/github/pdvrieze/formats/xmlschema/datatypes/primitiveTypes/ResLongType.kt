...
object ResLongType : ResolvedBuiltinAtomicType<XsdLong>,
    ResIIntegerType<XsdLong>, LongType<XsdLong> {
    ...
    override val mdlFacets: FacetList = FacetList(
        ...
        maxConstraint = // pass null as this has an initialization loop. The value is pre-normalized.
            ResolvedMaxInclusive.createUnverified(XsdLong(Long.MAX_VALUE)),
        minConstraint = ResolvedMinInclusive.createUnverified(XsdLong(Long.MIN_VALUE)),
    )
    ...
    override fun valueFromNormalized(normalized: XsdString): XsdLong {
        return XsdLong(normalized.toLong())
    }
