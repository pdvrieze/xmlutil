...
object ResDecimalType : ResPrimitiveDatatype<XsdDecimal>,
    IResolvedDecimalType<XsdDecimal>, DecimalType<XsdDecimal> {
    ...
    override fun valueFromNormalized(normalized: XsdString): XsdDecimal {
        return XsdDecimal(normalized.xmlString)
    }

    override fun value(maybeValue: XsdAnySimple): XsdDecimal {
        return maybeValue as? XsdDecimal ?: value((maybeValue as? XsdString) ?: XsdString(maybeValue.xmlString))
    }
