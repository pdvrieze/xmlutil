    ...
    init {
        val rawSchema = XSSchema(
            ...
            attributes = listOf(
                XSGlobalAttribute(
                    name = XsdNCName("type"),
                    type = ResQNameType.mdlQName
                ),
                XSGlobalAttribute(
                    name = XsdNCName("nil"),
                    type = ResBooleanType.mdlQName
                ),
                XSGlobalAttribute(
                    name = XsdNCName("schemaLocation"),
                    simpleType = XSLocalSimpleType(
                        XSSimpleList(
                            itemTypeName = ResAnyURIType.mdlQName
                        )
                    )
                ),
                XSGlobalAttribute(name = XsdNCName("noNamespaceSchemaLocation"), type = ResAnyURIType.mdlQName),
            ),
        )
