...
object ResNMTokensType : ResListDatatype<XsdNMTokens,  XsdNMToken>, NMTokensType<XsdNMTokens, XsdNMToken> {

    override val baseType: ResListDatatype<XsdAnySimple, XsdAnySimple> get() = AnonListBaseType
    override val itemType: ResNMTokenType get() = ResNMTokenType
    override val mdlItemTypeDefinition: ResNMTokenType get() = itemType

    override val simpleType: Nothing? get() = null

    override val simpleDerivation: ResolvedSimpleType.Derivation
        get() = BuiltinListDerivation(ResIDRefType)
