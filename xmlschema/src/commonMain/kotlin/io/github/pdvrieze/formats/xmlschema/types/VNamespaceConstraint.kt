...
data class VNamespaceConstraint<E : VQNameListBase.IElem>(
    ...
    fun matches(name: XsdQName, context: ContextT, schema: ResolvedSchemaLike): Boolean = when (mdlVariety) {
    ...
    fun reduceStrict(availableNames: List<XsdQName>, isSiblingName: ContextT, schema: ResolvedSchemaLike): VNamespaceConstraint<E> {
