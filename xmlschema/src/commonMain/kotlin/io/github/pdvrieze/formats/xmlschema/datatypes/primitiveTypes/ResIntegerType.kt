...
import io.github.pdvrieze.formats.xmlschema.resolved.facets.ResolvedFractionDigits
...
object ResIntegerType : ResolvedBuiltinAtomicType<XsdInteger>,
    ResIIntegerType<XsdInteger>, IntegerType<XsdInteger> {
    ...
    override fun valueFromNormalized(normalized: XsdString): XsdInteger {
        return XsdInteger(normalized.toLong())
    }
