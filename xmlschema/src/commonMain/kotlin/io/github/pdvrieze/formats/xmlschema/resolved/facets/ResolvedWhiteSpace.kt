...
import io.github.pdvrieze.xml.schematypes.facets.FacetWhiteSpace

class ResolvedWhiteSpace(rawPart: XSWhiteSpace) : ResolvedFacet(rawPart), FacetWhiteSpace {
    ...
    override val value: WhitespaceValue = rawPart.value
