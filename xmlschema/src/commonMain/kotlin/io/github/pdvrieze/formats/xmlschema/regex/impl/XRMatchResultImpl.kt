...
internal class XRMatchResultImpl
/**
...
constructor (internal val input: CharSequence, internal val regex: XRRegex) : XMatchResult {
    ...
    override val groups: XMatchGroupCollection = object: XMatchNamedGroupCollection, AbstractCollection<XMatchGroup?>() {
        override val size: Int
            get() = this@XRMatchResultImpl.groupCount


        override fun iterator(): Iterator<XMatchGroup?> {
            return object: Iterator<XMatchGroup?> {
                var nextIndex: Int = 0
        ...
        override fun get(index: Int): XMatchGroup? {
            val value = group(index) ?: return null
            return XMatchGroup(value, getStart(index) until getEnd(index))
        }

        override fun get(name: String): XMatchGroup? {
    ...
    override fun next(): XMatchResult? {
