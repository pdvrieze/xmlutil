...
object ResUnsignedByteType : ResolvedBuiltinAtomicType<XsdUnsignedByte>, ResIIntegerType<XsdUnsignedByte>,
UnsignedByteType<XsdUnsignedByte> {
    ...
    override fun valueFromNormalized(normalized: XsdString): XsdUnsignedByte {
        return XsdUnsignedByte(normalized.toString().toUByte())
    }
