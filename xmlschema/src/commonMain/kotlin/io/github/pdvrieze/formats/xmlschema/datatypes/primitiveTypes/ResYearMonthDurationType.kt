...
object ResYearMonthDurationType : ResolvedBuiltinAtomicType<XsdYearMonthDuration>, YearMonthDurationType<XsdYearMonthDuration> {
    ...
    override fun valueFromNormalized(normalized: XsdString): XsdYearMonthDuration {
        return XsdYearMonthDuration(normalized.xmlString)
    }

    override fun value(maybeValue: XsdAnySimple): XsdYearMonthDuration {
    ...
    override fun validateValue(value: Any, version: SchemaVersion) {
        require(value is XsdYearMonthDuration)
