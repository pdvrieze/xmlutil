...
object ResDateTimeType : ResPrimitiveDatatype<XsdDateTime>,
    DateTimeType<XsdDateTime> {
    ...
    override fun valueFromNormalized(normalized: XsdString): XsdDateTime {
        return XsdDateTime(normalized.xmlString)
    }

    override fun value(maybeValue: XsdAnySimple): XsdDateTime {
        return maybeValue as? XsdDateTime ?: value((maybeValue as? XsdString) ?: XsdString(maybeValue.xmlString))
    }
