...
object ResTimeType : ResPrimitiveDatatype<XsdTime>, TimeType<XsdTime> {
    ...
    override fun valueFromNormalized(normalized: XsdString): XsdTime {
        return XsdTime(normalized.xmlString)
    }

    override fun value(maybeValue: XsdAnySimple): XsdTime {
        return maybeValue as? XsdTime ?: value((maybeValue as? XsdString) ?: XsdString(maybeValue.xmlString))
    }
