 ...
 * Back reference node;
 */
open internal class XRBackReferenceSet(val referencedGroup: Int, val consCounter: Int, val ignoreCase: Boolean = false)
    : XRSimpleSet() {
    ...
    protected fun getReferencedGroupValue(matchResult: XRMatchResultImpl) = matchResult.group(referencedGroup)
