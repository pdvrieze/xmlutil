...
import io.github.pdvrieze.xml.schematypes.facets.FacetTotalDigits

class ResolvedTotalDigits(rawPart: XSTotalDigits) : ResolvedFacet(rawPart), FacetTotalDigits {
