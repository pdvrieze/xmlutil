...
object ResUnsignedIntType : ResolvedBuiltinAtomicType<XsdUnsignedInt>,
    ResIIntegerType<XsdUnsignedInt>, UnsignedIntType<XsdUnsignedInt> {
    ...
    override fun valueFromNormalized(normalized: XsdString): XsdUnsignedInt {
        return XsdUnsignedInt(normalized.toUInt())
    }
