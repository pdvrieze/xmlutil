...
/*
interface VInteger : XsdDecimal {
    override fun toLong(): Long
    override fun toInt(): Int

    override fun compareTo(other: XsdDecimal): Int = when(other) {
        is XsdBigDecimal -> VBigDecimalImpl(xmlString).compareTo(other)
...
/*
private class IntInstance(private val i: Int) : XsdInteger {
...
/*
@JvmInline
private value class LongInstance(private val l: Long) : XsdInteger {
...
/*
@JvmInline
value class VDouble(val value: Double): XsdAtomic {
...
/*
@JvmInline
value class VFloat(val value: Float): XsdAtomic {
    override val xmlString: String get() = value.toString()
