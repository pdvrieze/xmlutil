...
import io.github.pdvrieze.xml.schematypes.facets.FacetEnumeration
import io.github.pdvrieze.xml.schematypes.values.XsdAnySimple

class ResolvedEnumeration<out T : XsdAnySimple>(
    rawPart: XSEnumeration,
    dataType: ResolvedSimpleType<*>
) : ResolvedFacet(rawPart), FacetEnumeration {
    ...
    override val value: T = dataType.value(rawPart.value) as T
