...
import io.github.pdvrieze.xml.schematypes.facets.FacetFractionDigits

class ResolvedFractionDigits(rawPart: XSFractionDigits) :
    ResolvedFacet(rawPart), FacetFractionDigits {
