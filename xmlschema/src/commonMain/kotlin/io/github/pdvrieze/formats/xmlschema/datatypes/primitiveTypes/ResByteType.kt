...
object ResByteType : ResolvedBuiltinAtomicType<XsdByte>,
    ResIIntegerType<XsdByte>, ByteType<XsdByte> {
    ...
    override val mdlFacets: FacetList = FacetList(
        ...
        maxConstraint = ResolvedMaxInclusive.createUnverified(XsdByte(127)),
        minConstraint = ResolvedMinInclusive.createUnverified(XsdByte(-128)),
    )
    ...
    override fun valueFromNormalized(normalized: XsdString): XsdByte {
        return XsdByte(normalized.xmlString.toByte())
    }
