...
object ResNormalizedStringType : ResolvedBuiltinAtomicType<XsdNormalizedString>, ResIStringType<XsdNormalizedString>,
    NormalizedStringType<XsdNormalizedString> {
    ...
    override fun valueFromNormalized(normalized: XsdString): XsdNormalizedString {
        return normalized as? XsdNormalizedString ?: XsdNormalizedString(normalized.xmlString)
    }

    override fun value(maybeValue: XsdAnySimple): XsdNormalizedString {
        return maybeValue as? XsdNormalizedString ?: value((maybeValue as? XsdString) ?: XsdString(maybeValue.xmlString))
    }

    override fun validateValue(value: Any, version: SchemaVersion) {
        check(value is XsdNormalizedString)
    }
