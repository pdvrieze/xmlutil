...
import io.github.pdvrieze.xml.schematypes.facets.FacetExplicitTimezone

class ResolvedExplicitTimezone(rawPart: XSExplicitTimezone) :
    ResolvedFacet(rawPart), FacetExplicitTimezone {
    override val model by lazy { ResolvedAnnotated.Model(rawPart) }
    override val isOptional: Boolean
        get() = value == XSExplicitTimezone.Value.OPTIONAL
    override val isProhibited: Boolean
        get() = value == XSExplicitTimezone.Value.PROHIBITED
    override val isRequired: Boolean
        get() = value == XSExplicitTimezone.Value.REQUIRED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ResolvedExplicitTimezone
