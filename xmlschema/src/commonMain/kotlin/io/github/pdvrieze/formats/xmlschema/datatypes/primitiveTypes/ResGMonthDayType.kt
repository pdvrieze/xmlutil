...
object ResGMonthDayType : ResPrimitiveDatatype<XsdGMonthDay>, ResFiniteDateType<XsdGMonthDay>, GMonthDayType<XsdGMonthDay> {
    ...
    override fun valueFromNormalized(normalized: XsdString): XsdGMonthDay {
        return XsdGMonthDay(normalized.xmlString)
    }

    override fun value(maybeValue: XsdAnySimple): XsdGMonthDay {
        return maybeValue as? XsdGMonthDay ?: value((maybeValue as? XsdString) ?: XsdString(maybeValue.xmlString))
    }

    override fun validateValue(value: Any, version: SchemaVersion) {
        check(value is XsdGMonthDay)
    }
